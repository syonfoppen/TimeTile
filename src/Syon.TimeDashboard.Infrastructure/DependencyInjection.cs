...
using Syon.TimeDashboard.Infrastructure.ApiClients.AzureDevOps;
using Syon.TimeDashboard.Infrastructure.ApiClients.SevenPace;
using Syon.TimeDashboard.Infrastructure.Persistence;
using Syon.TimeDashboard.Infrastructure.Security;
using Syon.TimeDashboard.Infrastructure.Services;

namespace Syon.TimeDashboard.Infrastructure;
...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, AppSettings settings)
    {
        ...
        var dbPath = Path.Combine(
            ...
            "SyonTimeDashboard", "dashboard.db");
